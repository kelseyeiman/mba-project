...
var TestData = {
  Fats: JSON.parse(`[
    {"step_number" : "1" , "step_description" : "Notebook & labelling of tubes - 10min" , "fixed_time" : "600" , "variable_time" : "" , "flex_time" : ""} , 
    ...
    {"step_number" : "8" , "step_description" : "Cool samples - 10 minutes" , "fixed_time" : "600" , "variable_time" : "" , "flex_time" : "true"} , 
    ...
    {"step_number" : "13" , "step_description" : "Centrifuge - 5 min" , "fixed_time" : "300" , "variable_time" : "" , "flex_time" : "true"} , 
    ...
    {"step_number" : "16" , "step_description" : "Evaporation - 10min" , "fixed_time" : "600" , "variable_time" : "" , "flex_time" : "true"} , 
    ...
    {"step_number" : "20" , "step_description" : "Reflux - 5 minutes in hot water - 5min" , "fixed_time" : "300" , "variable_time" : "" , "flex_time" : "true"} , 
    ...
    {"step_number" : "24" , "step_description" : "Reflux - 40 min in hot water - 40min" , "fixed_time" : "2400" , "variable_time" : "" , "flex_time" : "true"} , 
    {"step_number" : "25" , "step_description" : "Cool sample - 10min" , "fixed_time" : "600" , "variable_time" : "" , "flex_time" : "true"} , 
    ...
    {"step_number" : "29" , "step_description" : "Centrifuge - 5 min" , "fixed_time" : "300" , "variable_time" : "" , "flex_time" : "true"} , 
    {"step_number" : "30" , "step_description" : "Prepare GC vial - 20s per sample" , "fixed_time" : "" , "variable_time" : "20" , "flex_time" : ""} , 
  ...
  Peroxide_Value: JSON.parse(`[
    ...
    {"step_number" : "3" , "step_description" : "Stir - 10min" , "fixed_time" : "600" , "variable_time" : "" , "flex_time" : ""} , 
    ...
    {"step_number" : "8" , "step_description" : "Stir - 1min per sample" , "fixed_time" : "" , "variable_time" : "60" , "flex_time" : ""} , 
    ...
    Water_Content: JSON.parse(`[
      ...
      {"step_number" : "4" , "step_description" : "Run standard/sample - 5min" , "fixed_time" : "300" , "variable_time" : "" , "flex_time" : "true"} , 
    ...
    Fat_Soluble_Vitamins: JSON.parse(`[
      ...
      {"step_number" : "3" , "step_description" : "Weigh sample - 2min per sample" , "fixed_time" : "" , "variable_time" : "60" , "flex_time" : ""} , 
      {"step_number" : "4" , "step_description" : "Prepare Solvent - 10min" , "fixed_time" : "600" , "variable_time" : "" , "flex_time" : ""} , 
      {"step_number" : "5" , "step_description" : "Add solvent to each sample - 1min per sample" , "fixed_time" : "" , "variable_time" : "60" , "flex_time" : ""} , 
      ...
      {"step_number" : "7" , "step_description" : "Stir - 40 min" , "fixed_time" : "2400" , "variable_time" : "" , "flex_time" : "true"} , 
      ...
      {"step_number" : "15" , "step_description" : "Prepare GC vial - 20s per sample" , "fixed_time" : "" , "variable_time" : "20" , "flex_time" : ""} , 
    ...
    Vitamin_B12: JSON.parse(`[
      ...
      {"step_number" : "7" , "step_description" : "Prepare GC vial - 20s per sample" , "fixed_time" : "" , "variable_time" : "20" , "flex_time" : ""} , 
    ...
    Cholesterol: JSON.parse(`[
      ...
      {"step_number" : "17" , "step_description" : "Prepare GC vial - 20s per sample" , "fixed_time" : "" , "variable_time" : "20" , "flex_time" : ""} , 
